package com.qa.NSEIndia.utilities;
...
public class ElementUtilities {
	...
	public boolean isElementDisplayed(By locator) {
		...
		if (elementCount == 1) {
			System.out.println("single elememt is displayed: " + locator);
			return true;
		} else {
			System.out.println("multiple or zero element are displayed");
			return false;
		}

	}

	public boolean isElementDisplayed(By locator, int elementExpectedCount) {
		int elementCount = getElements(locator).size();

		if (elementCount == elementExpectedCount) {
			System.out.println("elememt is displayed: " + locator + " with occurance of" + elementExpectedCount);
			return true;
		} else {
			System.out.println("multiple or zero element are displayed");
			return false;
	...
	public List<String> getDropDrownTesxtList(By locator) {
		Select select = new Select(driver.findElement(locator));
	...
	public void selectValuesFromDropDown(By locator, String optionText) {
	...
	public void selectValuesFromDropDownWithoutSelectClass(By locator, String optionText) {
	...
	public void doSearch(By searchFeild, String searchKey, By sugestions, String value) throws InterruptedException {

		// driver.findElement(searchFeild).sendKeys(searchKey);

		doSendKeys(searchFeild, searchKey);

		Thread.sleep(3000);

		List<WebElement> suggList = getElements(sugestions);
	...
	/**
	 * this method is uesd to enter the value in the text feild with a pause of
	 * 500ms (by default)
	 * 
	 * @param locator
	 * @param value
	...
	public void level4SubMenuHandlingByUsingClick(By level1, By level2, By level3, By level4)
	...
	public void level4SubMenuHandlingUsingMouseHover(By level1, By level2, By level3, By level4)
			throws InterruptedException {

		Actions act = new Actions(driver);
		act.moveToElement(getElement(level1));
		Thread.sleep(1000);
